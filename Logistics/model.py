...
class highwayNet(nn.Module):
    ...
    def __init__(self,args):
        ...
        '''
        self.dec_lstm = torch.nn.LSTM(self.encoder_size*796, self.decoder_size) # 64*796, 128
    ...
    def forward(self,hist,nbrs,masks,lat_enc,lon_enc):
        ...
        new_hs = new_hs.view(new_hs.shape[0], -1) # 128 by 64*796
        fut_pred = self.decode(new_hs) 
        '''
        ...
        '''
        return fut_pred#, soft_attn_weights_ha#, nbr_loc
